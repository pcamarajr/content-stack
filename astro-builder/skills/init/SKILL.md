---
description: Initialize an Astro 6 project with Claude. Scans the repo for existing assets, interviews the user to define purpose, content types, i18n, and design system, then generates CLAUDE.md and a .astro-builder/ configuration folder.
---
